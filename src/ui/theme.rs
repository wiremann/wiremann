...
pub struct Theme {
    ...
    pub library_albums_section_bg: Rgba,
    pub library_albums_section_bg_hover: Rgba,
    pub library_albums_section_bg_active: Rgba,
    pub library_albums_section_title_text: Rgba,
    pub library_albums_section_meta_text: Rgba,
    pub library_albums_section_empty_text: Rgba,

    // Library Page Album View Section
    pub library_album_section_track_count: Rgba,
    pub library_album_section_table_header_text: Rgba,
    pub library_album_section_table_header_border: Rgba,
    pub library_album_section_table_slno: Rgba,
    pub library_album_section_table_title: Rgba,
    pub library_album_section_table_artist: Rgba,
    pub library_album_section_table_album: Rgba,
    pub library_album_section_table_duration: Rgba,
    pub library_album_section_bg_hover: Rgba,
    pub library_album_section_header_title: Rgba,
    pub library_album_section_header_meta: Rgba,
    pub library_album_section_button_bg: Rgba,
    pub library_album_section_button_text: Rgba,
    pub library_album_section_button_secondary_bg: Rgba,
    pub library_album_section_button_secondary_text: Rgba,

    // Library Page Artists Section
    pub library_artists_section_title: Rgba,
    pub library_artists_section_bg: Rgba,
    pub library_artists_section_bg_hover: Rgba,
    pub library_artists_section_bg_active: Rgba,
    pub library_artists_section_title_text: Rgba,
    pub library_artists_section_meta_text: Rgba,
    pub library_artists_section_empty_text: Rgba,

    // Library Page Artist View Section
    pub library_artist_section_track_count: Rgba,
    pub library_artist_section_table_header_text: Rgba,
    pub library_artist_section_table_header_border: Rgba,
    pub library_artist_section_table_slno: Rgba,
    pub library_artist_section_table_title: Rgba,
    pub library_artist_section_table_artist: Rgba,
    pub library_artist_section_table_album: Rgba,
    pub library_artist_section_table_duration: Rgba,
    pub library_artist_section_bg_hover: Rgba,
    pub library_artist_section_header_title: Rgba,
    pub library_artist_section_header_meta: Rgba,
    pub library_artist_section_button_bg: Rgba,
    pub library_artist_section_button_text: Rgba,
    pub library_artist_section_button_secondary_bg: Rgba,
    pub library_artist_section_button_secondary_text: Rgba,
    ...
    pub library_playlist_section_header_title: Rgba,
...
impl Default for Theme {
    ...
    fn default() -> Self {
        Theme {
            ...
            library_albums_section_bg_active: rgba(0xFFFFFF10),
            library_albums_section_title_text: rgb(0xFAFAFA),
            library_albums_section_meta_text: rgb(0x71717A),
            library_albums_section_empty_text: rgb(0x71717A),

            library_album_section_track_count: rgb(0x71717A),
            library_album_section_table_header_text: rgb(0x71717A),
            library_album_section_table_header_border: rgba(0xFFFFFF14),
            library_album_section_table_slno: rgb(0x71717A),
            library_album_section_table_title: rgb(0xFAFAFA),
            library_album_section_table_artist: rgb(0x71717A),
            library_album_section_table_album: rgb(0x71717A),
            library_album_section_table_duration: rgb(0x71717A),
            library_album_section_bg_hover: rgba(0xFFFFFF14),
            library_album_section_header_title: rgb(0xFFFFFF),
            library_album_section_header_meta: rgb(0x71717A),
            library_album_section_button_bg: rgb(0xFAFAFA),
            library_album_section_button_text: rgb(0x09090B),
            library_album_section_button_secondary_bg: rgba(0xFFFFFF14),
            library_album_section_button_secondary_text: rgb(0xFAFAFA),

            library_artists_section_title: rgb(0xFFFFFF),
            library_artists_section_bg: rgba(0xFFFFFF00),
            library_artists_section_bg_hover: rgba(0xFFFFFF08),
            library_artists_section_bg_active: rgba(0xFFFFFF10),
            library_artists_section_title_text: rgb(0xFAFAFA),
            library_artists_section_meta_text: rgb(0x71717A),
            library_artists_section_empty_text: rgb(0x71717A),

            library_artist_section_track_count: rgb(0x71717A),
            library_artist_section_table_header_text: rgb(0x71717A),
            library_artist_section_table_header_border: rgba(0xFFFFFF14),
            library_artist_section_table_slno: rgb(0x71717A),
            library_artist_section_table_title: rgb(0xFAFAFA),
            library_artist_section_table_artist: rgb(0x71717A),
            library_artist_section_table_album: rgb(0x71717A),
            library_artist_section_table_duration: rgb(0x71717A),
            library_artist_section_bg_hover: rgba(0xFFFFFF14),
            library_artist_section_header_title: rgb(0xFFFFFF),
            library_artist_section_header_meta: rgb(0x71717A),
            library_artist_section_button_bg: rgb(0xFAFAFA),
            library_artist_section_button_text: rgb(0x09090B),
            library_artist_section_button_secondary_bg: rgba(0xFFFFFF14),
            ...
            library_playlist_section_header_title: rgb(0xFFFFFF),
