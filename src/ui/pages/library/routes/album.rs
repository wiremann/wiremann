    ...
    fn render_track(index: usize, id: TrackId, cx: &mut App) -> Div {
        ...
        div().h_16().py_1().child(
            div()
                ...
                .rounded_md()
                .cursor_pointer()
                .hover(|this| this.bg(theme.library_album_section_bg_hover))
                ...
                .child(
                    div()
                        ...
                        .items_center()
                        .justify_center()
                        .text_color(theme.library_album_section_table_slno)
                        .text_sm()
                    ...
                    div()
                        ...
                        .child(
                            div().flex_1().flex().flex_col().justify_center().child(
                                div()
                                    .text_color(theme.library_album_section_table_title)
                ...
                .child(
                    div()
                        ...
                        .items_center()
                        .justify_start()
                        .text_color(theme.library_album_section_table_artist)
                        .text_sm()
                        .child(artists)
                        .overflow_hidden()
                        .whitespace_nowrap()
                ...
                .child(
                    div()
                        ...
                        .items_center()
                        .justify_start()
                        .text_color(theme.library_album_section_table_album)
                        .text_sm()
                        .child(album)
                        .overflow_hidden()
                        .whitespace_nowrap()
                ...
                .child(
                    div()
                        ...
                        .font_family("JetBrains Mono")
                        .text_sm()
                        .text_color(theme.library_album_section_table_duration)
                        .child(format!(
                            "{:02}:{:02}",
...
impl Render for AlbumViewSection {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let Some(album) = self
            ...
            .read(cx)
            .as_ref()
            .and_then(|id| state.library.albums.get(id))
        else {
            return div();
        };

        controller.request_album_thumbnails(&[album.id], cx);
        ...
        div()
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .truncate()
                                    .text_ellipsis()
                                    .text_color(theme.library_album_section_header_title)
                                    .child(album_name),
                            )
                            .child(
                                div()
                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .py_2()
                                            .rounded_lg()
                                            .bg(theme.library_album_section_button_bg)
                                            .text_color(theme.library_album_section_button_text)
                                            .font_weight(FontWeight::MEDIUM)
                                            .cursor_pointer()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .py_2()
                                            .rounded_lg()
                                            .bg(theme.library_album_section_button_secondary_bg)
                                            .text_color(
                                                theme.library_album_section_button_secondary_text,
                                            )
                                            .font_weight(FontWeight::MEDIUM)
                                            .cursor_pointer()
            ...
            .child(
                div()
                    ...
                    .text_color(theme.library_album_section_table_header_text)
                    .border_b_1()
                    .border_color(theme.library_album_section_table_header_border)
                    .px_12()
                    .child(
                        div()
                            .w_10()
            ...
            .child(floating_scrollbar(
                "album_tracks_section_scrollbar",
                scroll_handle,
                RightPad::Pad,
            ))
    }
